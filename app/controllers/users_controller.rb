class UsersController < ApplicationController
  ...
  def show
    render json: { user: UserBlueprint.render_as_hash(@user, view: :full),
                   list: NotificationBlueprint.render_as_hash(current_user.notifications.nearly.page(1), view: :normal),
  ...
  def notifications
    page = params[:page] || 1
    render json: NotificationBlueprint.render(current_user.notifications.nearly.page(page), root: :list, view: :normal), status: 200
  end
